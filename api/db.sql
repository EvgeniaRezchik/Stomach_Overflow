...
post_id integer,
comment_id integer,
sense ENUM("is following you!", "is following your post:", "published a post:", "commented on you:", "commented on the post you are following:", "locked the post:", "locked the comment:", "reacted to your post:", "reacted to your comment:") NOT NULL,
...
("Kyouki_no_mad_scientist", "103b07211b2422e294012627a31b21428a34cd7f3b1537f7aaccb9e15b9a2ef7ca860c0b3809b7061cff7c1f11b91a74cb07658080cdafdd8255c8d78924da43", "Hououin Kyouma", "mail1@gmail.com", "default_avatar.png", 19, "admin", 1),
("Tutturu", "103b07211b2422e294012627a31b21428a34cd7f3b1537f7aaccb9e15b9a2ef7ca860c0b3809b7061cff7c1f11b91a74cb07658080cdafdd8255c8d78924da43", "Mayushi☆", "mail2@gmail.com", "default_avatar.png", 32, "user", 1),
("Superhacker_1905", "103b07211b2422e294012627a31b21428a34cd7f3b1537f7aaccb9e15b9a2ef7ca860c0b3809b7061cff7c1f11b91a74cb07658080cdafdd8255c8d78924da43", "Daru", "mail3@gmail.com", "default_avatar.png", 14, "admin", 1),
("Kurigohan", "103b07211b2422e294012627a31b21428a34cd7f3b1537f7aaccb9e15b9a2ef7ca860c0b3809b7061cff7c1f11b91a74cb07658080cdafdd8255c8d78924da43", "Kurisu Makise", "mail4@gmail.com", "default_avatar.png", 15, "user", 1),
("Shiny_finger", "103b07211b2422e294012627a31b21428a34cd7f3b1537f7aaccb9e15b9a2ef7ca860c0b3809b7061cff7c1f11b91a74cb07658080cdafdd8255c8d78924da43", "Moeka Kiryuu", "mail5@gmail.com", "default_avatar.png", 8, "user", 1),
("Luka_Urushibara", "103b07211b2422e294012627a31b21428a34cd7f3b1537f7aaccb9e15b9a2ef7ca860c0b3809b7061cff7c1f11b91a74cb07658080cdafdd8255c8d78924da43", "Luka Urushibara", "mail6@gmail.com", "default_avatar.png", 12, "user", 1),
("FarisNyanNyan", "103b07211b2422e294012627a31b21428a34cd7f3b1537f7aaccb9e15b9a2ef7ca860c0b3809b7061cff7c1f11b91a74cb07658080cdafdd8255c8d78924da43", "Faris NyanNyan", "mail7@gmail.com", "default_avatar.png", 8, "user", 1),
("skyclad2010", "103b07211b2422e294012627a31b21428a34cd7f3b1537f7aaccb9e15b9a2ef7ca860c0b3809b7061cff7c1f11b91a74cb07658080cdafdd8255c8d78924da43", "Suzuha Amane", "mail8@gmail.com", "default_avatar.png", 12, "user", 1);
...
("Is it possible to marinate bananas?", "active", "Tutturu-♪ Mayushi is a big fan of bananas and wants to try something interesting with them. The first idea that came to mind is to marinate them, but is it really possible? If so, is it a really good idea?", (SELECT id FROM users WHERE login = "Tutturu"), null),
...
((SELECT id FROM users WHERE login = "Luka_Urushibara"), "Try to add citric acid to your caramel. At least it helps me, so I think this advice also can help you.", (SELECT id FROM posts WHERE title = "Why may sugar not caramelize?"), null, null),
...
((SELECT id FROM users WHERE login = "Kurigohan"), null, (SELECT id FROM comments WHERE content = "Try to add citric acid to your caramel. At least it helps me, so I think this advice also can help you."), "like"),
((SELECT id FROM users WHERE login = "Tutturu"), null, (SELECT id FROM comments WHERE content = "Try to add citric acid to your caramel. At least it helps me, so I think this advice also can help you."), "like"),
((SELECT id FROM users WHERE login = "FarisNyanNyan"), null, (SELECT id FROM comments WHERE content = "Try to add citric acid to your caramel. At least it helps me, so I think this advice also can help you."), "like"),
